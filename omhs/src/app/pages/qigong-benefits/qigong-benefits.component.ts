...
@Component({
  selector: 'app-qigong-benefits',
  templateUrl: './qigong-benefits.component.html',
  styleUrls: ['../pages.css', './qigong-benefits.component.css']
})
export class QigongBenefitsComponent implements OnInit {
