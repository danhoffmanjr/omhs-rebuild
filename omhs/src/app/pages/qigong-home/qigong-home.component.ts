...
@Component({
  selector: 'app-qigong-home',
  templateUrl: './qigong-home.component.html',
  styleUrls: ['../pages.css', './qigong-home.component.css']
})
export class QigongHomeComponent implements OnInit {
