...
@Component({
  selector: 'app-acupuncture-needles',
  templateUrl: './acupuncture-needles.component.html',
  styleUrls: ['../pages.css', './acupuncture-needles.component.css']
})
export class AcupunctureNeedlesComponent implements OnInit {
